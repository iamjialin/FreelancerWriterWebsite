    ...
    return (
        <>
            ...
            <Box display="flex" justifyContent="center" width="100%" fontFamily='TravelingTypewriter' marginBottom={"20vh"}>
                <Grid container width={"60vw"} marginTop={"2%"}>
                    ...
                    <Grid item xs={7} fontFamily={"Lato"} fontSize={"20px"}>
                        ...
                        <p>My personal blog is ....., Suscribe me at <Link href="https://dreamcoders.wixsite.com/my-site">here</Link> to get my latest posts</p>
                    </Grid>
                </Grid>
